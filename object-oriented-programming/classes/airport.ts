...
class Airport{
    ...
    emergencyLanding():void{
        ...
        console.log(`Aterrizaje de emergencia en el aeropuerto ${this._name}. La pista esta cerrada`)
    }
    displayInfo(): void{
        console.log(`Nombre: ${this._name}`)
        console.log(`Location: ${this._location}`)
        console.log(`Estado de la pista: ${this.runwayStatus}`)
        console.log(`Trafico: ${this.trafficLevel}`)
    }
}

const myAirport = new Airport('Aeropuerto Int', 'Ciudad ABC')
